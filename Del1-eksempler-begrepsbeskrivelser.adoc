...
|===
a|*Eksempel på noen anbefalte opplysninger*, hentet fra Termbasen til Standard Norge 2022-08-30, for begrepet https://termbasen.standard.no/term/167505059109122/nb?origin=%2Fsearch-results%3FsearchText%3Dinnholdsdefinisjon%26icsCodes%3D%26sources%3D%26start%3D0%26range%3D100[«innholdsdefinisjon»]:
