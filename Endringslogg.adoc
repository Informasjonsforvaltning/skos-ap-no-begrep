...
** Følgende egenskaper har fått endret verdiområde/_range_:
*** Vedrdiområde/range for «kilde» er endret fra kilde(r) til kilde(r) ev. med den ønskede rekkefølge eksplisitt oppgitt. Dette for å kunne oppgi rekkefølge mellom kildene.  
** Følgende egenskaper utgår:
