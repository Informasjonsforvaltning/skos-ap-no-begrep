...
=== Endringer fra v.2.0.3 v.2.0.5

Kun redaksjonelle justeringer, for å rette opp skrivefeil og mangler i endringsloggen (endringer ved publisering av v.2.0.0). 
