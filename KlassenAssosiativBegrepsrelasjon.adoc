...
| Anvendelse / _Usage note_  | Klassen brukes til å representere en https://termlex.no/term/174124357601677/nb[assosiativ begrepsrelasjon &#x29C9;, window="_blank", role="ext-link"].

__This class is used to represent an https://termlex.no/term/174124357601677/en[associative concept relation &#x29C9;, window="_blank", role="ext-link"].__
