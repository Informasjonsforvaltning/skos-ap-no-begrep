...
| Anvendelse / _Usage note_  | Klassen brukes til å representere en  https://termlex.no/term/171137526403399/nb[generisk begrepsrelasjon &#x29C9;, window="_blank", role="ext-link"].

__This class is used to represent a https://termlex.no/term/171137526403399/en[generic concept relation &#x29C9;, window="_blank", role="ext-link"].__
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til https://termlex.no/term/171137526104769/nb[det generiske begrepet &#x29C9;, window="_blank", role="ext-link"] i en generisk begrepsrelasjon.

__This property is used to specify the https://termlex.no/term/171137526104769/en[generic concept &#x29C9;, window="_blank", role="ext-link"] in a generic concept relation.__
...
| Verdiområde / _Range_  |skos:Concept
| Anvendelse / _Usage note_  | Egenskapen brukes til å referere til https://termlex.no/term/171137527605260/nb[det spesifikke begrepet &#x29C9;, window="_blank", role="ext-link"] i en generisk begrepsrelasjon.

__This property is used to refer to https://termlex.no/term/171137527605260/en[specific concept &#x29C9;, window="_blank", role="ext-link"] in a generic concept relation.__
| Multiplisitet / _Multiplicity_  |1..n
| Kravnivå / _Requirement level_  |Obligatorisk / _Mandatory_
