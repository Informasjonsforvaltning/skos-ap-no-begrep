...
|Anvendelse / _Usage note_ | Klassen brukes til å representere en https://termlex.no/term/171137529308815/nb[partitiv begrepsrelasjon &#x29C9;, window="_blank", role="ext-link"].

__This class is used to represent a https://termlex.no/term/171137529308815/en[partitive concept relation &#x29C9;, window="_blank", role="ext-link"].__
...
|Anvendelse / _Usage note_ | Egenskapen brukes til å referere til et annet begrep (https://termlex.no/term/171137529405477/nb[delbegrep &#x29C9;, window="_blank", role="ext-link"]) som inngår i dette begrepet, i en partitiv begrepsrelasjon mellom disse.

__This property is used to refer to another concept (the https://termlex.no/term/171137529405477/en[partitive concept &#x29C9;, window="_blank", role="ext-link"]) that is part of this concept, in a partitive concept relation between the two concepts.__
...
|Verdiområde / _Range_ |skos:Concept
|Anvendelse / _Usage note_ | Egenskapen brukes til å referere til et annet begrep (https://termlex.no/term/171137529905841/nb[helhetsbegrepet &#x29C9;, window="_blank", role="ext-link"]) som inneholder dette begrepet, i en partitiv begrepsrelasjon mellom disse.

__This property is used to refer to another concept (the https://termlex.no/term/171137529905841/en[comprehensive concept &#x29C9;, window="_blank", role="ext-link"]) that contains this concept, in a partitive concept relation between the two concepts.__
|Multiplisitet / _Multiplicity_ |1..n
|Kravnivå / _Requirement level_ |Obligatorisk / _Mandatory_
