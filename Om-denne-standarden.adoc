...
* hva som skal/bør/kan tas med når et begrep eller en begrepssamling beskrives (del 1)
* hvordan beskrivelser av begreper og begrepssamlinger gjøres tilgjengelige i maskinlesbare formater i henhold til https://www.w3.org/TR/skos-reference/[_SKOS Simple Knowledge Organization System_] (del 2)
