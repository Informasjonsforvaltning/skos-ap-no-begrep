...
|===
a|*Eksempel på en begrepsbeskrivelse med kun obligatoriske opplysninger*, hentet fra NAV 2022-08-23, for begrepet https://data.nav.no/begrep/BEGREP-975[«mødrekvote»]:
...
|===
a|*Eksempel på en assosiativ relasjon*, hentet fra NAV 2022-08-23, for begrepet 1169 https://data.nav.no/begrep/BEGREP-1169[«lovlig opphold»]:
