...
* *navn* (maks. ett per skriftspråk), og det skal oppgis hvilket skriftspråk navnet er skrevet på
...
* *beskrivelse* (maks. én per skriftspråk), og det skal oppgis hvilket skriftspråk beskrivelsen er skrevet på
