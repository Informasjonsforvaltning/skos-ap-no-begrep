...
| Anvendelse / _Usage note_ | Klassen brukes til å representere et https://termlex.no/term/171137529705724/nb[begrep &#x29C9;, window="_blank", role="ext-link"].

__The class is used to represent a https://termlex.no/term/171137529705724/en[concept &#x29C9;, window="_blank", role="ext-link"].__
| URI |skos:Concept
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi en https://termlex.no/term/171137522902468/nb[anbefalt term &#x29C9;, window="_blank", role="ext-link"]. Egenskapen bør gjentas når termen finnes på flere skriftspråk.

__This property is used to specify a https://termlex.no/term/171137522902468/en[preferred term &#x29C9;, window="_blank", role="ext-link"]. This property should be repeated for parallel language versions of the term.__
...
| URI |skos:definition
| Verdiområde / _Range_ |rdf:langString
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi https://termlex.no/term/171137526903743/nb[definisjon &#x29C9;, window="_blank", role="ext-link"] av et begrep, når det ikke er behov for å oppgi mer enn selve definisjonsteksten. Egenskapen bør gjentas når definisjonen finnes på flere skriftspråk.

__This property is used to specify the https://termlex.no/term/171137526903743/en[definition &#x29C9;, window="_blank", role="ext-link"] of a concept, when there is no need to specify more than the definition itself. This property should be repeated for parallel language versions of the definition.__
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi https://termlex.no/term/171137526903743/nb[definisjon &#x29C9;, window="_blank", role="ext-link"] av et begrep, når det er behov for å oppgi mer enn definisjonsteksten. Egenskapen bør gjentas når definisjonen finnes på flere skriftspråk.

__This property is used to specify the https://termlex.no/term/171137526903743/en[definition &#x29C9;, window="_blank", role="ext-link"] to a concept, when there is a need to specify more than the definition. This property should be repeated for parallel language versions of the definition.__
| Multiplisitet / _Multiplicity_ |1..n
| Kravnivå / _Requirement level_ |Obligatorisk / _Mandatory_
| Merknad 1 / _Note 1_ | Det skal være minimum én definisjon (direkte angivelse eller via definisjonsobjekt) og maksimum én per skriftspråk og målgruppe.
...
| Multiplisitet / _Multiplicity_ |1..n
| Kravnivå / _Requirement level_ |Obligatorisk / _Mandatory_
| Merknad  / _Note_ |  Se https://data.norge.no/guide/veileder-beskrivelse-av-datasett/#om-identifikator[Om identifikator (dct:identifier) i Veileder for beskrivelse av datasett osv. &#x29C9;, window="_blank", role="ext-link"]

__See https://data.norge.no/guide/veileder-beskrivelse-av-datasett/#om-identifikator[Om identifikator (dct:identifier) i Veileder for beskrivelse av datasett osv. (in Norwegian only) &#x29C9;, window="_blank", role="ext-link"].__
|===
...
| Kravnivå / _Requirement level_ |Obligatorisk / _Mandatory_
| Merknad / _Note_ | Virksomhetens identifikasjonsnummer bør brukes, for eksempel https://data.norge.no/concepts/f6639f5e-280e-4dbb-991e-3faca3bf622c[Enhetsregisterets organisasjonsnummer &#x29C9;, window="_blank", role="ext-link"].

__The organization’s identifier should be used, e.g. the organization number registered in the Central Coordinating Register for Legal Entities (CCR).__
|===
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi https://termlex.no/term/171137528906133/nb[fagområde &#x29C9;, window="_blank", role="ext-link"] som begrepet kan grupperes/klassifiseres under. Dette oppgis enten som tekst med språkkode eller som kodet verdi. Hvis tekst brukes, og når teksten finnes på flere skriftspråk, bør egenskapen gjentas for hvert skriftspråk.

__This property is used to specify a https://termlex.no/term/171137528906133/en[domain &#x29C9;, window="_blank", role="ext-link"] (subject field) under which the concept may be grouped/classified, either as a text with language code or as a coded value. When text is used, the property should be repeated for parallel language versions of the text.__
...
| URI |skos:altLabel
| Verdiområde / _Range_ |rdf:langString
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi https://termlex.no/term/171137525006547/nb[tillatt term &#x29C9;, window="_blank", role="ext-link"] til begrepet. Egenskapen bør gjentas når termen finnes på flere skriftspråk.

__This property is used to specify an https://termlex.no/term/171137525006547/en[admitted term &#x29C9;, window="_blank", role="ext-link"] to a concept. This property should be repeated for parallel language versions of the term.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Anbefalt / _Recommended_
|===
...
Eksempel i RDF Turtle, hentet 2022-12-09 fra Termlex til Standard Norge, for begrep https://termlex.no/term/171137527404105/nb[«individualbegrep» &#x29C9;, window="_blank", role="ext-link"]:
-----
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å knytte begrepet til et annet begrep som dette begrepet er del av. Begrepet er et https://termlex.no/term/171137529405477/nb[delbegrep &#x29C9;, window="_blank", role="ext-link"], og det andre begrepet er https://termlex.no/term/171137529905841/nb[helhetsbegrepet &#x29C9;, window="_blank", role="ext-link"], i en partitiv relasjon mellom disse.

__This property is used to refer to the concept that this concept is a part of. This concept is a https://termlex.no/term/171137529405477/en[partitive concept &#x29C9;, window="_blank", role="ext-link"] and the other concept is the https://termlex.no/term/171137529905841/en[comprehensive concept &#x29C9;, window="_blank", role="ext-link"], in a partitive concept relation between the two concepts.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
...
| Merknad 3 / _Note 3_ | Bruk <<Begrep-har-partitiv-begrepsrelasjon>> når det er behov for å oppgi https://termlex.no/term/171137526103099/nb[inndelingskriterium &#x29C9;, window="_blank", role="ext-link"].

__Use <<Begrep-har-partitiv-begrepsrelasjon>> when there is a need to specify the https://termlex.no/term/171137526103099/en[criterion of subdivision &#x29C9;, window="_blank", role="ext-link"].__
|===
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi en https://termlex.no/term/171137526104694/nb[assosiativ begrepsrelasjon &#x29C9;, window="_blank", role="ext-link"] som begrepet har med et annet begrep, når det er behov for å beskrive relasjonsrollen til dette begrepet.

__This property is used to refer to an https://termlex.no/term/171137526104694/en[associative relation &#x29C9;, window="_blank", role="ext-link"] that this concept has with another concept, when there is a need to describe the relation role of this concept.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
|===
...
| Verdiområde / _Range_ |rdf:langString
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi en https://termlex.no/term/171137522602191/nb[frarådd term &#x29C9;, window="_blank", role="ext-link"]. Egenskapen bør gjentas når termen finnes på flere skriftspråk.

__This property is used to specify a https://termlex.no/term/171137522602191/en[deprecated term &#x29C9;, window="_blank", role="ext-link"]. This property should be repeated for parallel language versions of the term.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
|===
...
| Verdiområde / _Range_ |skos:Concept
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til et annet begrep som dette begrepet generaliserer. Begrepet er https://termlex.no/term/171137526104769/nb[det generiske begrepet &#x29C9;, window="_blank", role="ext-link"] og det andre begrepet er https://termlex.no/term/171137527605260/nb[det spesifikke begrepet &#x29C9;, window="_blank", role="ext-link"], i en generisk relasjon mellom disse.

__This property is used to refer to another concept that this concept generalizes. This concept is the https://termlex.no/term/171137526104769/en[generic concept &#x29C9;, window="_blank", role="ext-link"] and the other concept is the https://termlex.no/term/171137527605260/en[specific concept &#x29C9;, window="_blank", role="ext-link"], in a generic concept relation between the two concepts.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
...
| Merknad 3 / _Note 3_ | Bruk <<Begrep-har-generisk-begrepsrelasjon>> når det er behov for å oppgi https://termlex.no/term/171137526103099/nb[inndelingskriterium &#x29C9;, window="_blank", role="ext-link"].

__Use <<Begrep-har-generisk-begrepsrelasjon>> when there is a need to specify the https://termlex.no/term/171137526103099/en[criterion of subdivision &#x29C9;, window="_blank", role="ext-link"].__
|===
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi en https://termlex.no/term/171137526403399/nb[generisk begrepsrelasjon &#x29C9;, window="_blank", role="ext-link"] som begrepet har med et annet begrep, når det er behov for å oppgi https://termlex.no/term/171137526103099/nb[inndelingskriterium &#x29C9;, window="_blank", role="ext-link"].

__This property is used to refer to a https://termlex.no/term/171137526403399/en[generic concept relation &#x29C9;, window="_blank", role="ext-link"] that this concept has with another concept, in order to specify the https://termlex.no/term/171137526103099/en[criterion of subdivision &#x29C9;, window="_blank", role="ext-link"].__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
|===
...
| Anvendelse / _Usage note_ | Egenskapen brukes til å oppgi en https://termlex.no/term/171137529308815/nb[partitiv begrepsrelasjon &#x29C9;, window="_blank", role="ext-link"] som begrepet har med et annet begrep, når det er behov for å oppgi https://termlex.no/term/171137526103099/nb[inndelingskriterium &#x29C9;, window="_blank", role="ext-link"].

__This property is used to refer to a https://termlex.no/term/171137529308815/en[partitive concept relation &#x29C9;, window="_blank", role="ext-link"] that this concept has with another concept, when there is a need to specify the https://termlex.no/term/171137526103099/en[criterion of subdivision &#x29C9;, window="_blank", role="ext-link"].__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
|===
...
| URI |xkos:hasPart
| Verdiområde / _Range_ |skos:Concept
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til et annet begrep som dette begrepet inneholder. Begrepet er https://termlex.no/term/171137529905841/nb[helhetsbegrepet &#x29C9;, window="_blank", role="ext-link"] og det andre begrepet https://termlex.no/term/171137529405477/nb[delbegrep &#x29C9;, window="_blank", role="ext-link"], i en partitiv relasjon mellom disse.

__This property is used to refer to the concept that this concept has as a part. This concept is the https://termlex.no/term/171137529905841/en[comprehensive concept &#x29C9;, window="_blank", role="ext-link"] and the other concept is the https://termlex.no/term/171137529405477/en[partitive concept &#x29C9;, window="_blank", role="ext-link"], in a partitive concept relation between the two concepts.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
...
| Verdiområde / _Range_ |skos:Concept
| Anvendelse / _Usage note_ | Egenskapen brukes til å referere til et annet begrep som dette begrepet spesialiserer. Begrepet er https://termlex.no/term/171137527605260/nb[det spesifikke begrepet &#x29C9;, window="_blank", role="ext-link"] og det andre begrepet er https://termlex.no/term/171137526104769/nb[det generiske begrepet &#x29C9;, window="_blank", role="ext-link"], i en generisk relasjon mellom disse.

__This property is used to refer to another concept that this concept specializes. This concept is the https://termlex.no/term/171137527605260/en[specific concept &#x29C9;, window="_blank", role="ext-link"] and the other concept is the https://termlex.no/term/171137526104769/en[generic concept &#x29C9;, window="_blank", role="ext-link"], in a generic concept relation between the two concepts.__
| Multiplisitet / _Multiplicity_ |0..n
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
...
| Kravnivå / _Requirement level_ |Valgfri / _Optional_
| Merknad / _Note_ | Når begrepsbeskrivelsen gjøres tilgjengelig utenfor virksomheten, hvis en av kategoriene i EUs kontrollerte vokabular https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://publications.europa.eu/resource/authority/concept-status[__Concept status__ &#x29C9;, window="_blank", role="ext-link"] passer til begrepets status, skal egenskapen referere til den aktuelle kategorien.

__When making the concept description available outside the organization, if one of the categories in EU’s https://op.europa.eu/en/web/eu-vocabularies/concept-scheme/-/resource?uri=http://publications.europa.eu/resource/authority/concept-status[Concept status &#x29C9;, window="_blank", role="ext-link"] is suitable for the status of the concept, this property shall refer to that category.__
|===
...
| Verdiområde / _Range_ |rdf:langString and/or xsd:anyURI
