...
|Anvendelse /  _Usage note_  | Klassen brukes til å representere en samling av https://termlex.no/term/171137529705724/nb[begreper &#x29C9;, window="_blank", role="ext-link"].

__This class is used to represent a collection of https://termlex.no/term/171137529705724/en[concepts &#x29C9;, window="_blank", role="ext-link"].__
|URI |skos:Collection
