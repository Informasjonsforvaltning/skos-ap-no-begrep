...
_This class is used to represent a https://termbasen.standard.no/term/165575612703717/eng[definition] when there is a need to describe more than the definition itself._
| URI |euvoc:XlNote
