...
|euvoc| `\http://publications.europa.eu/ontology/euvoc#` | https://op.europa.eu/en/web/eu-vocabularies/dataset/-/resource?uri=http://publications.europa.eu/resource/dataset/eurovoc[EuroVoc &#x29C9;, window="_blank", role="ext-link"]
