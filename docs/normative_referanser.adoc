...
* https://www.difi.no/referansekatalogen/begrepsstandarder/[_Forvaltningsstandard for begrepsbeskrivelser_]: Standarden stiller krav til innhold i beskrivelse av begrep og begrepssamling.
